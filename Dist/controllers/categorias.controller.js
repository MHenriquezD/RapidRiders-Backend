...
const cargarEmpresa = (req, res) => {
    categorias_schema_1.Categorias.find({ _id: req.params.id }).then(result => {
        var _a;
        const empresa = (_a = result[0].empresas) === null || _a === void 0 ? void 0 : _a.find(empresa => empresa.id == req.params.idEmpresa);
...
const addEmpresa = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const categoria = yield categorias_schema_1.Categorias.findById(req.params.id);
    if (categoria) {
        (_a = categoria.empresas) === null || _a === void 0 ? void 0 : _a.push(empresa);
...
const addProducto = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const categoria = yield categorias_schema_1.Categorias.findById(req.params.id);
    if (categoria) {
        const empresa = (_b = categoria.empresas) === null || _b === void 0 ? void 0 : _b.find(empresa => empresa.id == req.params.idEmpresa);
        if (empresa) {
            (_c = empresa.productos) === null || _c === void 0 ? void 0 : _c.push(producto);
